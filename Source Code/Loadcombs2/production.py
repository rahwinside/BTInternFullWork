    ...
    def gen_excel(self):
        ...
        try:
            ...
            for x in lc_entity_fin:
                ...
                ldcase.write(2, i + 2, int(lc_id_fin[lc_entity_fin.index(x)]))
                i += 1
            ...
            for x in spcname:
                ...
                ldstep.write(1, i + 4, int(spcid[spcname.index(x)]))
                i += 1
            ...
            for j in range(0, 16370):
                ldstep.write(0, j + i + 4,
                             '=IF(CREATE_LOADADD!A' + str(j + 4) + '="", "", CREATE_LOADADD!A' + str(j + 4) + ')')
            wkbk.close()
            ...
            for i in range(0, len(loadstep_matrix)):
                ...
                if (loadstep_sheet.cell_value(i + 2, 1) == 'linear static'):
                    ...
                    if (loadstep_matrix[i].count(1) == 1):
                        ...
                        if not (str(loadstep_sheet.cell_value(0, loadstep_matrix[i].index(1) + 4)) in spcname):
