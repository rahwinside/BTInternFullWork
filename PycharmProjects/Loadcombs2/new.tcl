...
*attributeupdateint loadcols 45 3240 1 2 0 1
*attributeupdateint loadcols 45 4113 1 0 0 10
*attributeupdatedouble loadcols 45 4232 1 2 0 0
*attributeupdateint loadcols 45 4234 1 0 0 6
*attributeupdateint loadcols 45 4088 1 0 0 25
*attributeupdatestring loadcols 45 4089 1 0 0 "UPW"
*attributeupdatedouble loadcols 45 4090 1 0 0 0.001
*attributeupdatedouble loadcols 45 4091 1 0 0 0.001
*attributeupdatedouble loadcols 45 4092 1 0 0 1e-007
*attributeupdateint loadcols 45 4238 1 0 0 20
*attributeupdatedouble loadcols 45 4240 1 0 0 0.001
*attributeupdatedouble loadcols 45 10201 1 0 0 1
*attributeupdateint loadcols 45 10614 1 2 0 1
*endnotehistorystate {Attached attributes to loadcol "NLPARM"}
*startnotehistorystate {Attached attributes to loadcol "NLPARM"}
*attributeupdateint loadcols 45 4113 1 1 0 10
*endnotehistorystate {Attached attributes to loadcol "NLPARM"}
...
*attributeupdateint loadsteps 1 4709 1 1 0 9
*attributeupdateentity loadsteps 1 4145 1 1 0 loadcols 4
*attributeupdateentity loadsteps 1 9931 1 1 0 loadcols 45
...
*attributeupdateentity loadsteps 1 2159 1 1 0 loadcols 7
...
#Pretension Created!
*startnotehistorystate {LoadSteps Creation}
*createmark loadcols 1 "SPC_2" "FAT2"
*createmark outputblocks 1
*createmark groups 1
*loadstepscreate "FAT1" 1
*attributeupdateint loadsteps 2 4143 1 1 0 1
*attributeupdateint loadsteps 2 4709 1 1 0 1
*attributeupdateentity loadsteps 2 4145 1 1 0 loadcols 5
*attributeupdateentity loadsteps 2 4147 1 1 0 loadcols 9
...
#end of iter 1
*startnotehistorystate {LoadSteps Creation}
*createmark loadcols 1 "SPC_3" "FAT3"
*createmark outputblocks 1
*createmark groups 1
*loadstepscreate "FAT2" 1
*attributeupdateint loadsteps 3 4143 1 1 0 1
*attributeupdateint loadsteps 3 4709 1 1 0 1
*attributeupdateentity loadsteps 3 4145 1 1 0 loadcols 6
*attributeupdateentity loadsteps 3 4147 1 1 0 loadcols 10
...
#end of iter 2
*startnotehistorystate {LoadSteps Creation}
*createmark loadcols 1 "SPC_2" "FAT1"
*createmark outputblocks 1
*createmark groups 1
*loadstepscreate "FAT4" 1
*attributeupdateint loadsteps 4 4143 1 1 0 1
*attributeupdateint loadsteps 4 4709 1 1 0 9
*attributeupdateentity loadsteps 4 4145 1 1 0 loadcols 5
*attributeupdateentity loadsteps 4 4147 1 1 0 loadcols 8
*attributeupdateentity loadsteps 4 9931 1 1 0 loadcols 45
...
#end of iter 3
*startnotehistorystate {LoadSteps Creation}
*createmark loadcols 1 "SPC_2" "FAT4"
*createmark outputblocks 1
*createmark groups 1
*loadstepscreate "FAT14" 1
*attributeupdateint loadsteps 5 4143 1 1 0 1
*attributeupdateint loadsteps 5 4709 1 1 0 9
*attributeupdateentity loadsteps 5 4145 1 1 0 loadcols 5
*attributeupdateentity loadsteps 5 4147 1 1 0 loadcols 11
*attributeupdateentity loadsteps 5 9931 1 1 0 loadcols 45
...
#end of iter 4
*startnotehistorystate {LoadSteps Creation}
*createmark loadcols 1 "SPC_1" "FAT1"
*createmark outputblocks 1
*createmark groups 1
*loadstepscreate "FAT15" 1
*attributeupdateint loadsteps 6 4143 1 1 0 1
*attributeupdateint loadsteps 6 4709 1 1 0 1
*attributeupdateentity loadsteps 6 4145 1 1 0 loadcols 4
*attributeupdateentity loadsteps 6 4147 1 1 0 loadcols 8
...
#end of iter 6
*startnotehistorystate {LoadSteps Creation}
*createmark loadcols 1 "SPC_1" "FAT4"
*createmark outputblocks 1
*createmark groups 1
*loadstepscreate "LS1" 1
*attributeupdateint loadsteps 8 4143 1 1 0 1
*attributeupdateint loadsteps 8 4709 1 1 0 9
*attributeupdateentity loadsteps 8 4145 1 1 0 loadcols 4
*attributeupdateentity loadsteps 8 4147 1 1 0 loadcols 11
*attributeupdateentity loadsteps 8 9931 1 1 0 loadcols 45
...
#end of iter 7
*startnotehistorystate {LoadSteps Creation}
*createmark loadcols 1 "SPC_1" "FAT2"
*createmark outputblocks 1
*createmark groups 1
*loadstepscreate "LS2" 1
*attributeupdateint loadsteps 9 4143 1 1 0 1
*attributeupdateint loadsteps 9 4709 1 1 0 9
*attributeupdateentity loadsteps 9 4145 1 1 0 loadcols 4
*attributeupdateentity loadsteps 9 4147 1 1 0 loadcols 9
*attributeupdateentity loadsteps 9 9931 1 1 0 loadcols 45
