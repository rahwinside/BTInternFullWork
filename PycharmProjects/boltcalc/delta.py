...
class UX(QDialog, newui.Ui_bolt_ui):
    ...
    def fillSpreadsheet(self):
        try:
            ...
            wb = openpyxl.load_workbook('bolt_cal_template.xlsx')
            ws = wb['calculation']
            ...
            ws['A44'] = 'Head/Part1'
            ws['B44'] = '=MIN(O7,Q16)'
            ws['D44'] = '=IF(B44>C44,"Pass","Fail")'
            nClamped = int(self.nClampedPartsText.text())

            for i in range(1, nClamped + 1):
                ws['A'+str(i+44)] = 'Part'+str(i+1)+'/Part'+str(i+2)
                ws['B'+str(i+44)] = '=MIN(Q'+str(i+16)+',Q'+str(i+17)+')'
                ws['D'+str(i+44)] = '=IF(B'+str(i+44)+'>C'+str(i+44)+',"Pass","Fail")'

            ws['A' + str(i + 44)] = 'Part' + str(i + 1) + '/Threaded Part'
            ws['B' + str(i + 44)] = '=MIN(Q' + str(i + 16) + ',O35)'
            ws['D' + str(i + 44)] = '=IF(B' + str(i + 44) + '>C' + str(i + 44) + ',"Pass","Fail")'
    ...
    def exportResults(self):
        ...
        for i in range(0, 60):
            if i==41:
                continue
            for j in range(0, 5):
                item = QTableWidgetItem(str(ws.cell(None, i, j).value))
